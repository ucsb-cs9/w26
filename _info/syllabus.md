---
title: "Syllabus, CMPSC 9, Winter 2026"
layout: handout
ready: true
---
...
* **Course Web Site**: <https://ucsb-cs9.github.io/w26/>
* **Instructor**:  [Richert Wang](http://www.cs.ucsb.edu/~richert)
   * Email is richert@ucsb.edu, BUT please use [Piazza](https://piazza.com/ucsb/winter2026/cmpsc9) for course related communication.
* **Lecture**: Tu Th 3:30pm-4:45pm (BUCHN 1910)
* **TAs**:  {{site.ta_list_full}} (contact via Piazza)
* **Mentors**: {{site.mentors_list}} (contact via Piazza)
* **Lab** (50 minute lab sections): Wednesdays 12pm, 1pm, 2pm, 3pm (SSMS 1301)
* **Office Hours**: See <https://ucsb-cs9.github.io/w26/info/office_hours/>
...
|-----------------------------------------------|---------------------------|
| Academic Integrity Contract (Tuesday 1/13)    | 1 %                       |
| Midterm (Thursday 2/5), 3:30pm - 4:45pm       | 35 %                      |
| Final (Thursday 3/19), 4:00pm - 6:00pm        | 35 %                      |
| Homeworks                                     | 9 %                       |
| Labs                                          | 20 %                      |
...
* All labs must be submitted by the due date. There will be a 24-hour late window open on Gradescope for each lab unless stated otherwise. Submissions during the late window period will have a **20% (20-point)** deduction from your grade. We will only consider your most recent submission.
